    ...
    [8639], {
        2342: (e, t, r) => {
            ...
            var s, n, a = r(51642),
                ...
                k = r(71609),
                S = r(13e3);
            o.ev.utils.randomPrivateKey;
            let I = () => {
                    let e = o.ev.utils.randomPrivateKey(),
                        t = v(e),
                        r = new Uint8Array(64);
            ...
            function _(e) {
                try {
                    return o.ev.ExtendedPoint.fromHex(e), !0
                } catch {
                    return !1
                }
            }
            let A = (e, t) => o.ev.sign(e, t.slice(0, 32)),
                B = o.ev.verify,
                W = e => a.Buffer.isBuffer(e) ? e : e instanceof Uint8Array ? a.Buffer.from(e.buffer, e.byteOffset, e.byteLength) : a.Buffer.from(e);
            class x {
                constructor(e) {
                    Object.assign(this, e)
                }
                encode() {
                    return a.Buffer.from((0, g.serialize)(P, this))
                }
                static decode(e) {
                    return (0, g.deserialize)(P, this, e)
                }
                static decodeUnchecked(e) {
                    return (0, g.deserializeUnchecked)(P, this, e)
                }
            }
            let P = new Map,
                E = 1;
            class N extends x {
                ...
                static findProgramAddressSync(e, t) {
                    ...
                    for (; 0 != i;) {
                        try {
                            let s = e.concat(a.Buffer.from([i]));
                ...
                static isOnCurve(e) {
                    return _(new N(e).toBytes())
                }
            }
            N.default = new N("11111111111111111111111111111111"), P.set(N, {
                kind: "struct",
                fields: [
                    ["_bn", "u256"]
                ]
            ...
            let q = (e = "publicKey") => p.av(32, e),
                K = (e = "signature") => p.av(64, e),
                z = (e = "string") => {
                    let t = p.w3([p.DH("length"), p.DH("lengthPadding"), p.av(p.cY(p.DH(), -8), "chars")], e),
                        r = t.decode.bind(t),
                        i = t.encode.bind(t);
                    return t.decode = (e, t) => r(e, t).chars.toString(), t.encode = (e, t, r) => i({
                        chars: a.Buffer.from(e, "utf8")
                    }, t, r), t.alloc = e => p.DH().span + p.DH().span + a.Buffer.from(e, "utf8").length, t
                };
            ...
            class H {
                ...
                getMessageComponents() {
                    ...
                    return [n, [...t.map(([e]) => new N(e)), ...r.map(([e]) => new N(e)), ...i.map(([e]) => new N(e)), ...s.map(([e]) => new N(e))]]
                }
            ...
            function U(e, ...t) {
                let [r] = t;
                if (2 === t.length ? r + (t[1] ? ? 0) > e.length : r >= e.length) throw Error(D);
                return e.splice(...t)
            }
            class $ {
                constructor(e) {
                    this.header = void 0, this.accountKeys = void 0, this.recentBlockhash = void 0, this.instructions = void 0, this.indexToProgramIds = new Map, this.header = e.header, this.accountKeys = e.accountKeys.map(e => new N(e)), this.recentBlockhash = e.recentBlockhash, this.instructions = e.instructions, this.instructions.forEach(e => this.indexToProgramIds.set(e.programIdIndex, this.accountKeys[e.programIdIndex]))
                }
                get version() {
                    return "legacy"
                }
                ...
                getAccountKeys() {
                    return new L(this.staticAccountKeys)
                }
                static compile(e) {
                    let [t, r] = H.compile(e.instructions, e.payerKey).getMessageComponents(), i = new L(r).compileInstructions(e.instructions).map(e => ({
                        programIdIndex: e.programIdIndex,
                ...
                serialize() {
                    ...
                    let r = this.instructions.map(e => {
                            ...
                            return R(n, i.length), {
                                programIdIndex: r,
                                keyIndicesCount: a.Buffer.from(s),
                                keyIndices: t,
                                dataLength: a.Buffer.from(n),
                                data: i
                            }
                        }),
                        i = [];
                    R(i, r.length);
                    let s = a.Buffer.alloc(1232);
                    a.Buffer.from(i).copy(s);
                    let n = i.length;
                    r.forEach(e => {
                        let t = p.w3([p.u8("programIdIndex"), p.av(e.keyIndicesCount.length, "keyIndicesCount"), p.O6(p.u8("keyIndex"), e.keyIndices.length, "keyIndices"), p.av(e.dataLength.length, "dataLength"), p.O6(p.u8("userdatum"), e.data.length, "data")]).encode(e, s, n);
                        n += t
                    }), s = s.slice(0, n);
                    let o = p.w3([p.av(1, "numRequiredSignatures"), p.av(1, "numReadonlySignedAccounts"), p.av(1, "numReadonlyUnsignedAccounts"), p.av(t.length, "keyCount"), p.O6(q("key"), e, "keys"), q("recentBlockhash")]),
                        c = {
                            ...
                            keys: this.accountKeys.map(e => W(e.toBytes())),
                            recentBlockhash: d().decode(this.recentBlockhash)
                        },
                        l = a.Buffer.alloc(2048),
                        u = o.encode(c, l);
                ...
                static from(e) {
                    ...
                    return new $({
                        ...
                        recentBlockhash: d().encode(a.Buffer.from(c)),
                        accountKeys: o,
                        instructions: u
                    })
                }
            ...
            class F {
                ...
                getAccountKeys(e) {
                    ...
                    return new L(this.staticAccountKeys, t)
                }
                isAccountSigner(e) {
                    return e < this.header.numRequiredSignatures
                }
                ...
                static compile(e) {
                    ...
                    let [s, n] = t.getMessageComponents(), a = new L(n, i).compileInstructions(e.instructions);
                    return new F({
                        header: s,
                        staticAccountKeys: n,
                        recentBlockhash: e.recentBlockhash,
                ...
                serialize() {
                    let e = [];
                    R(e, this.staticAccountKeys.length);
                    ...
                    let n = p.w3([p.u8("prefix"), p.w3([p.u8("numRequiredSignatures"), p.u8("numReadonlySignedAccounts"), p.u8("numReadonlyUnsignedAccounts")], "header"), p.av(e.length, "staticAccountKeysLength"), p.O6(q(), this.staticAccountKeys.length, "staticAccountKeys"), q("recentBlockhash"), p.av(r.length, "instructionsLength"), p.av(t.length, "serializedInstructions"), p.av(s.length, "addressTableLookupsLength"), p.av(i.length, "serializedAddressTableLookups")]),
                ...
                serializeInstructions() {
                    ...
                    for (let r of this.compiledInstructions) {
                        ...
                        let s = [];
                        R(s, r.data.length);
                        let n = p.w3([p.u8("programIdIndex"), p.av(i.length, "encodedAccountKeyIndexesLength"), p.O6(p.u8(), r.accountKeyIndexes.length, "accountKeyIndexes"), p.av(s.length, "encodedDataLength"), p.av(r.data.length, "data")]);
                        e += n.encode({
                ...
                serializeAddressTableLookups() {
                    ...
                    for (let r of this.addressTableLookups) {
                        ...
                        let n = p.w3([q("accountKey"), p.av(i.length, "encodedWritableIndexesLength"), p.O6(p.u8(), r.writableIndexes.length, "writableIndexes"), p.av(s.length, "encodedReadonlyIndexesLength"), p.O6(p.u8(), r.readonlyIndexes.length, "readonlyIndexes")]);
                        e += n.encode({
                ...
                static deserialize(e) {
                    ...
                    let s = {
                        ...
                        n = [],
                        a = Y(t);
                    for (let e = 0; e < a; e++) n.push(new N(U(t, 0, 32)));
                    let o = d().encode(U(t, 0, 32)),
                        c = Y(t),
                        l = [];
                    for (let e = 0; e < c; e++) {
                        let e = M(t),
            ...
            let V = {
                ...
                J = function(e) {
                    return e[e.BLOCKHEIGHT_EXCEEDED = 0] = "BLOCKHEIGHT_EXCEEDED", e[e.PROCESSED = 1] = "PROCESSED", e[e.TIMED_OUT = 2] = "TIMED_OUT", e[e.NONCE_INVALID = 3] = "NONCE_INVALID", e
                }({}),
                G = a.Buffer.alloc(64).fill(0);
            class X {
                constructor(e) {
                    this.keys = void 0, this.programId = void 0, this.data = a.Buffer.alloc(0), this.programId = e.programId, this.keys = e.keys, e.data && (this.data = e.data)
                }
                toJSON() {
                    return {
                        keys: this.keys.map(({
            ...
            class Z {
                ...
                add(...e) {
                    ...
                    return e.forEach(e => {
                        "instructions" in e ? this.instructions = this.instructions.concat(e.instructions) : "data" in e && "programId" in e && "keys" in e ? this.instructions.push(e) : this.instructions.push(new X(e))
                    }), this
                }
                compileMessage() {
                    let e, t, r;
                    ...
                    n.forEach(({
                        ...
                        t ? (u.push(e.toString()), o += 1, r || (c += 1)) : (h.push(e.toString()), r || (l += 1))
                    });
                    let g = u.concat(h),
                        p = t.map(e => {
                            let {
                ...
                _partialSign(e, ...t) {
                    ...
                    t.forEach(e => {
                        ...
                        this._addSignature(e.publicKey, W(t))
                    })
                }
                addSignature(e, t) {
...
Missing signature for public key${1===e.missing.length?"":"(s)"} [\`${e.missing.map(e=>e.toBase58()).join("`, `")}\`].`), Error(t)
                ...
                _serialize(e) {
                    ...
                    let i = r.length + 64 * t.length + e.length,
                        s = a.Buffer.alloc(i);
                    return j(t.length < 256), a.Buffer.from(r).copy(s, 0), t.forEach(({
                        signature: e
                    }, t) => {
                        null !== e && (j(64 === e.length, "signature has invalid length"), a.Buffer.from(e).copy(s, r.length + 64 * t))
                    }), e.copy(s, r.length + 64 * t.length), j(s.length <= 1232, `Transaction too large: ${s.length} > 1232`), s
                }
                get keys() {
                ...
                static from(e) {
                    ...
                    for (let e = 0; e < r; e++) {
                        let e = U(t, 0, 64);
                        i.push(d().encode(a.Buffer.from(e)))
                    }
                ...
                static populate(e, t = []) {
                    ...
                    return r.recentBlockhash = e.recentBlockhash, e.header.numRequiredSignatures > 0 && (r.feePayer = e.accountKeys[0]), t.forEach((t, i) => {
                        let s = {
                            signature: t == d().encode(G) ? null : d().decode(t),
            ...
            class Q {
                ...
                static decompile(e, t) {
                    ...
                    let l = e.staticAccountKeys.length - n - o;
                    j(l >= 0, "Message header is invalid");
                    let u = e.getAccountKeys(t),
                        d = u.get(0);
                    ...
                    for (let e of i) {
                        ...
                        for (let i of e.accountKeyIndexes) {
                            ...
                            e = i < n ? i < c : i < u.staticAccountKeys.length ? i - n < l : i - u.staticAccountKeys.length < u.accountKeysFromLookups.writable.length, t.push({
                                pubkey: s,
                                isSigner: i < r.numRequiredSignatures,
                                isWritable: e
                            })
                        }
                        let i = u.get(e.programIdIndex);
            ...
            class ee {
                ...
                serialize() {
                    let e = this.message.serialize(),
                        t = [];
                    R(t, this.signatures.length);
                    let r = p.w3([p.av(t.length, "encodedSignaturesLength"), p.O6(K(), this.signatures.length, "signatures"), p.av(e.length, "serializedMessage")]),
                ...
                static deserialize(e) {
                    ...
                    return new ee(V.deserialize(new Uint8Array(t)), r)
                }
                sign(e) {
                    ...
                    for (let i of e) {
                        ...
                        j(e >= 0, `Cannot sign with non signer key ${i.publicKey.toBase58()}`), this.signatures[e] = A(t, i.secretKey)
                    }
                }
                addSignature(e, t) {
            ...
            let et = new N("SysvarC1ock11111111111111111111111111111111");
            new N("SysvarEpochSchedu1e111111111111111111111111"), new N("Sysvar1nstructions1111111111111111111111111");
            let er = new N("SysvarRecentB1ockHashes11111111111111111111"),
                ei = new N("SysvarRent111111111111111111111111111111111");
            new N("SysvarRewards111111111111111111111111111111"), new N("SysvarS1otHashes111111111111111111111111111"), new N("SysvarS1otHistory11111111111111111111111111");
            let es = new N("SysvarStakeHistory1111111111111111111111111");
...
` + n + a;
                    ...
                    super(s), this.signature = void 0, this.transactionMessage = void 0, this.transactionLogs = void 0, this.signature = t, this.transactionMessage = r, this.transactionLogs = i || void 0
                }
            ...
            let eu = p.I0("lamportsPerSignature"),
                ed = p.w3([p.DH("version"), p.DH("state"), q("authorizedPubkey"), q("nonce"), p.w3([eu], "feeCalculator")]),
                eh = ed.span;
            class eg {
                constructor(e) {
                ...
                static fromAccountData(e) {
                    let t = ed.decode(W(e), 0);
                    return new eg({
                        authorizedPubkey: new N(t.authorizedPubkey),
                        nonce: new N(t.nonce).toString(),
            ...
            let ep = e => ({
                ...
                em = (i = 8, e => {
                    ...
                    return t.decode = (e, t) => {
                        let r = i(e, t);
                        return (0, m.k5)(a.Buffer.from(r))
                    }, t.encode = (e, t, i) => r((0, m.Bq)(e, 8), t, i), t
                }),
                ef = Object.freeze({
                    Create: {
                        index: 0,
                        layout: p.w3([p.DH("instruction"), p.Wg("lamports"), p.Wg("space"), q("programId")])
                    },
                    Assign: {
                        index: 1,
                        layout: p.w3([p.DH("instruction"), q("programId")])
                    },
                    Transfer: {
                        index: 2,
                        layout: p.w3([p.DH("instruction"), em("lamports")])
                    },
                    CreateWithSeed: {
                        index: 3,
                        layout: p.w3([p.DH("instruction"), q("base"), z("seed"), p.Wg("lamports"), p.Wg("space"), q("programId")])
                    },
                    AdvanceNonceAccount: {
                        index: 4,
                        layout: p.w3([p.DH("instruction")])
                    },
                    WithdrawNonceAccount: {
                        index: 5,
                        layout: p.w3([p.DH("instruction"), p.Wg("lamports")])
                    },
                    InitializeNonceAccount: {
                        index: 6,
                        layout: p.w3([p.DH("instruction"), q("authorized")])
                    },
                    ...
                    Allocate: {
                        index: 8,
                        layout: p.w3([p.DH("instruction"), p.Wg("space")])
                    },
                    AllocateWithSeed: {
                        index: 9,
                        layout: p.w3([p.DH("instruction"), q("base"), z("seed"), p.Wg("space"), q("programId")])
                    },
                    AssignWithSeed: {
                        index: 10,
                        layout: p.w3([p.DH("instruction"), q("base"), z("seed"), q("programId")])
                    },
                    TransferWithSeed: {
                        index: 11,
                        layout: p.w3([p.DH("instruction"), em("lamports"), z("seed"), q("programId")])
                    },
                    UpgradeNonceAccount: {
                        index: 12,
                        layout: p.w3([p.DH("instruction")])
            ...
            class eb {
                ...
                static createAccount(e) {
                    let t = el(ef.Create, {
                        lamports: e.lamports,
                        space: e.space,
                        programId: W(e.programId.toBuffer())
                    });
                    return new X({
                        keys: [{
                            pubkey: e.fromPubkey,
                ...
                static transfer(e) {
                    let t, r;
                    return "basePubkey" in e ? (t = el(ef.TransferWithSeed, {
                ...
                static assign(e) {
                    let t, r;
                    return "basePubkey" in e ? (t = el(ef.AssignWithSeed, {
                        base: W(e.basePubkey.toBuffer()),
                        seed: e.seed,
                        programId: W(e.programId.toBuffer())
                    }), r = [{
                ...
                static createNonceAccount(e) {
                    let t = new Z;
                    "basePubkey" in e && "seed" in e ? t.add(eb.createAccountWithSeed({
                ...
                static nonceInitialize(e) {
                    let t = el(ef.InitializeNonceAccount, {
                        authorized: W(e.authorizedPubkey.toBuffer())
                    });
                    return new X({
                        keys: [{
                ...
                static nonceAdvance(e) {
                    let t = el(ef.AdvanceNonceAccount);
                    return new X({
                        keys: [{
                            pubkey: e.noncePubkey,
                            isSigner: !1,
                ...
                static nonceWithdraw(e) {
                    let t = el(ef.WithdrawNonceAccount, {
                        lamports: e.lamports
                    });
                    return new X({
                        keys: [{
                ...
                static nonceAuthorize(e) {
                    let t = el(ef.AuthorizeNonceAccount, {
                        authorized: W(e.newAuthorizedPubkey.toBuffer())
                    });
                    return new X({
                        keys: [{
                            pubkey: e.noncePubkey,
                ...
                static allocate(e) {
                    let t, r;
                    return "basePubkey" in e ? (t = el(ef.AllocateWithSeed, {
                        base: W(e.basePubkey.toBuffer()),
                        seed: e.seed,
                        space: e.space,
                        programId: W(e.programId.toBuffer())
            ...
            eb.programId = new N("11111111111111111111111111111111");
            class ey {
                constructor() {}
                static getMinNumSignatures(e) {
                    return 2 * (Math.ceil(e / ey.chunkSize) + 1 + 1)
                }
                static async load(e, t, r, i, s) {
                    {
                        ...
                        if (null !== a) {
                            ...
                            a.data.length !== s.length && (o = o || new Z).add(eb.allocate({
                                accountPubkey: r.publicKey,
                                space: s.length
                            })), a.owner.equals(i) || (o = o || new Z).add(eb.assign({
                                accountPubkey: r.publicKey,
                                programId: i
                            })), a.lamports < n && (o = o || new Z).add(eb.transfer({
                                fromPubkey: t.publicKey,
                                toPubkey: r.publicKey,
                                lamports: n - a.lamports
                            }))
                        } else o = new Z().add(eb.createAccount({
                            fromPubkey: t.publicKey,
                        ...
                        null !== o && await eo(e, o, [t, r], {
                            commitment: "confirmed"
                        })
                    }
                    let n = p.w3([p.DH("instruction"), p.DH("offset"), p.DH("bytesLength"), p.DH("bytesLengthPadding"), p.O6(p.u8("byte"), p.cY(p.DH(), -8), "bytes")]),
                        o = ey.chunkSize,
                        c = 0,
                        l = s,
                        u = [];
                    for (; l.length > 0;) {
                        ...
                        u.push(eo(e, h, [t, r], {
                            commitment: "confirmed"
                        })), e._rpcEndpoint.includes("solana.com") && await ec(250), c += o, l = l.slice(o)
                    }
                    await Promise.all(u); {
                        let s = p.w3([p.DH("instruction")]),
                            n = a.Buffer.alloc(s.span);
                        s.encode({
                            instruction: 1
                        }, n);
                        let o = new Z().add({
                            ...
                            c = "processed",
                            l = await e.sendTransaction(o, [t, r], {
                        ...
                        if (d.err) throw Error(`Transaction ${l} failed (${JSON.stringify(d)})`);
                        for (;;) {
                            try {
                                if (await e.getSlot({
                                        commitment: c
            ...
            ey.chunkSize = 932, new N("BPFLoader2111111111111111111111111111111111");
            var ew = function(e) {
                    ...
                    var i = function r(i, s) {
                        ...
                        switch (typeof i) {
                            case "object":
                                ...
                                if (i.toJSON && "function" == typeof i.toJSON) return r(i.toJSON(), s);
                                if ("[object Array]" === (d = e.call(i))) {
                                    for (n = 0, o = "[", a = i.length - 1; n < a; n++) o += r(i[n], !0) + ",";
                                    return a > -1 && (o += r(i[n], !0)), o + "]"
                                }
                                if ("[object Object]" !== d) return JSON.stringify(i);
                                for (a = (c = t(i).sort()).length, o = "", n = 0; n < a;) void 0 !== (u = r(i[l = c[n]], !1)) && (o && (o += ","), o += JSON.stringify(l) + ":" + u), n++;
                                return "{" + o + "}";
                            case "function":
                            case "undefined":
            ...
            class eS {
                ...
                getEpochAndSlotIndex(e) {
                    if (e < this.firstNormalSlot) {
                        var t;
                        let r = ek(0 === (t = e + 32 + 1) ? 1 : (t--, t |= t >> 1, t |= t >> 2, t |= t >> 4, t |= t >> 8, t |= t >> 16, (t |= t >> 32) + 1)) - ek(32) - 1,
                ...
                getSlotsInEpoch(e) {
                    return e < this.firstNormalEpoch ? Math.pow(2, e + ek(32)) : this.slotsPerEpoch
                }
            }
            var eI = globalThis.fetch;
            class ev extends w.vE {
                constructor(e, t, r) {
                    super(e => {
                        let r = (0, w.kb)(e, {
                            autoconnect: !0,
            ...
            class e_ {
                ...
                static deserialize(e) {
                    ...
                    let {
                        addresses: i
                    } = p.w3([p.O6(q(), r / 32, "addresses")]).decode(e.slice(56));
                    return {
                        ...
                        authority: 0 !== t.authority.length ? new N(t.authority[0]) : void 0,
                        addresses: i.map(e => new N(e))
                    }
                }
            }
            let eA = {
                    index: 1,
                    layout: p.w3([p.DH("typeIndex"), em("deactivationSlot"), p.I0("lastExtendedSlot"), p.u8("lastExtendedStartIndex"), p.u8(), p.O6(q(), p.cY(p.u8(), -1), "authority")])
                },
                eB = /^[^:]+:\/\/([^:[]+|\[[^\]]+\])(:\d+)?(.*)/i,
                eW = (0, f.au)((0, f.KJ)(N), (0, f.Yj)(), e => new N(e)),
                ex = (0, f.PV)([(0, f.Yj)(), (0, f.eu)("base64")]),
                eP = (0, f.au)((0, f.KJ)(a.Buffer), ex, e => a.Buffer.from(e[0], "base64"));
            ...
            function eO(e) {
                return (0, f.au)(eC(e), eT, t => "error" in t ? t : { ...t,
                    result: (0, f.vt)(t.result, e)
                })
            }
            ...
            function eK(e, t) {
                return 0 === e ? new F({
                    header: t.header,
                    staticAccountKeys: t.accountKeys.map(e => new N(e)),
            ...
            let ez = (0, f.NW)({
                    foundation: (0, f.ai)(),
                    foundationTerm: (0, f.ai)(),
                    initial: (0, f.ai)(),
                    taper: (0, f.ai)(),
                    terminal: (0, f.ai)()
                }),
                eY = eO((0, f.YO)((0, f.me)((0, f.NW)({
                    epoch: (0, f.ai)(),
                    effectiveSlot: (0, f.ai)(),
                    amount: (0, f.ai)(),
                    postBalance: (0, f.ai)(),
                    commission: (0, f.lq)((0, f.me)((0, f.ai)()))
                })))),
                eR = (0, f.YO)((0, f.NW)({
                    slot: (0, f.ai)(),
                    prioritizationFee: (0, f.ai)()
                })),
                ej = (0, f.NW)({
                    total: (0, f.ai)(),
                    validator: (0, f.ai)(),
                ...
                eH = (0, f.NW)({
                    ...
                    slotsInEpoch: (0, f.ai)(),
                    absoluteSlot: (0, f.ai)(),
                    blockHeight: (0, f.lq)((0, f.ai)()),
                    transactionCount: (0, f.lq)((0, f.ai)())
                }),
                eD = (0, f.NW)({
                    slotsPerEpoch: (0, f.ai)(),
                    leaderScheduleSlotOffset: (0, f.ai)(),
                    warmup: (0, f.zM)(),
                    firstNormalEpoch: (0, f.ai)(),
                    firstNormalSlot: (0, f.ai)()
                }),
                eM = (0, f.g1)((0, f.Yj)(), (0, f.YO)((0, f.ai)())),
                eU = (0, f.me)((0, f.KC)([(0, f.NW)({}), (0, f.Yj)()])),
                e$ = (0, f.NW)({
                    err: eU
                }),
                eF = (0, f.eu)("receivedSignature"),
                eV = (0, f.NW)({
                    "solana-core": (0, f.Yj)(),
                    "feature-set": (0, f.lq)((0, f.ai)())
                }),
                eJ = (0, f.NW)({
                    program: (0, f.Yj)(),
                    programId: eW,
                ...
                eX = eL((0, f.NW)({
                    err: (0, f.me)((0, f.KC)([(0, f.NW)({}), (0, f.Yj)()])),
                    logs: (0, f.me)((0, f.YO)((0, f.Yj)())),
                    accounts: (0, f.lq)((0, f.me)((0, f.YO)((0, f.me)((0, f.NW)({
                        executable: (0, f.zM)(),
                        owner: (0, f.Yj)(),
                        lamports: (0, f.ai)(),
                        data: (0, f.YO)((0, f.Yj)()),
                        rentEpoch: (0, f.lq)((0, f.ai)())
                    }))))),
                    unitsConsumed: (0, f.lq)((0, f.ai)()),
                    returnData: (0, f.lq)((0, f.me)((0, f.NW)({
                        programId: (0, f.Yj)(),
                        data: (0, f.PV)([(0, f.Yj)(), (0, f.eu)("base64")])
                    }))),
                    innerInstructions: (0, f.lq)((0, f.me)((0, f.YO)((0, f.NW)({
                        index: (0, f.ai)(),
                        instructions: (0, f.YO)((0, f.KC)([eJ, eG]))
                    }))))
                })),
                eZ = eL((0, f.NW)({
                    byIdentity: (0, f.g1)((0, f.Yj)(), (0, f.YO)((0, f.ai)())),
                    range: (0, f.NW)({
                        firstSlot: (0, f.ai)(),
                        lastSlot: (0, f.ai)()
                    })
                ...
                e6 = eL((0, f.NW)({
                    total: (0, f.ai)(),
                    circulating: (0, f.ai)(),
                    nonCirculating: (0, f.ai)(),
                    nonCirculatingAccounts: (0, f.YO)(eW)
                })),
                e4 = (0, f.NW)({
                    amount: (0, f.Yj)(),
                    uiAmount: (0, f.me)((0, f.ai)()),
                    decimals: (0, f.ai)(),
                    uiAmountString: (0, f.lq)((0, f.Yj)())
                }),
                e7 = eL((0, f.YO)((0, f.NW)({
                    address: eW,
                    amount: (0, f.Yj)(),
                ...
                tn = (0, f.au)((0, f.KC)([(0, f.KJ)(a.Buffer), te]), (0, f.KC)([ex, te]), e => Array.isArray(e) ? (0, f.vt)(e, eP) : e),
                ta = (0, f.NW)({
                    executable: (0, f.zM)(),
                    owner: eW,
                    lamports: (0, f.ai)(),
                ...
                tc = (0, f.NW)({
                    state: (0, f.KC)([(0, f.eu)("active"), (0, f.eu)("inactive"), (0, f.eu)("activating"), (0, f.eu)("deactivating")]),
                    active: (0, f.ai)(),
                    inactive: (0, f.ai)()
                }),
                tl = eO((0, f.YO)((0, f.NW)({
                    ...
                    err: eU,
                    memo: (0, f.me)((0, f.Yj)()),
                    blockTime: (0, f.lq)((0, f.me)((0, f.ai)()))
                }))),
                tu = eO((0, f.YO)((0, f.NW)({
                    signature: (0, f.Yj)(),
                    slot: (0, f.ai)(),
                ...
                tf = (0, f.KC)([(0, f.NW)({
                    type: (0, f.KC)([(0, f.eu)("firstShredReceived"), (0, f.eu)("completed"), (0, f.eu)("optimisticConfirmation"), (0, f.eu)("root")]),
                    slot: (0, f.ai)(),
                    timestamp: (0, f.ai)()
                }), (0, f.NW)({
                    type: (0, f.eu)("createdBank"),
                    parent: (0, f.ai)(),
                    slot: (0, f.ai)(),
                    timestamp: (0, f.ai)()
                }), (0, f.NW)({
                    ...
                    timestamp: (0, f.ai)(),
                    stats: (0, f.NW)({
                        numTransactionEntries: (0, f.ai)(),
                        numSuccessfulTransactions: (0, f.ai)(),
                        numFailedTransactions: (0, f.ai)(),
                        maxTransactionsPerEntry: (0, f.ai)()
                    })
                }), (0, f.NW)({
                    type: (0, f.eu)("dead"),
                    slot: (0, f.ai)(),
                ...
                tS = (0, f.NW)({
                    votePubkey: (0, f.Yj)(),
                    nodePubkey: (0, f.Yj)(),
                    activatedStake: (0, f.ai)(),
                    epochVoteAccount: (0, f.zM)(),
                    epochCredits: (0, f.YO)((0, f.PV)([(0, f.ai)(), (0, f.ai)(), (0, f.ai)()])),
                    commission: (0, f.ai)(),
                    lastVote: (0, f.ai)(),
                    rootSlot: (0, f.me)((0, f.ai)())
                }),
                tI = eO((0, f.NW)({
                    current: (0, f.YO)(tS),
                    delinquent: (0, f.YO)(tS)
                })),
                tv = (0, f.KC)([(0, f.eu)("processed"), (0, f.eu)("confirmed"), (0, f.eu)("finalized")]),
                t_ = (0, f.NW)({
                    slot: (0, f.ai)(),
                    confirmations: (0, f.me)((0, f.ai)()),
                    err: eU,
                    confirmationStatus: (0, f.lq)(tv)
                }),
                tA = eL((0, f.YO)((0, f.me)(t_))),
                tB = eO((0, f.ai)()),
                tW = (0, f.NW)({
                    accountKey: eW,
                    writableIndexes: (0, f.YO)((0, f.ai)()),
                    readonlyIndexes: (0, f.YO)((0, f.ai)())
                }),
                tx = (0, f.NW)({
                    signatures: (0, f.YO)((0, f.Yj)()),
                    message: (0, f.NW)({
                        accountKeys: (0, f.YO)((0, f.Yj)()),
                        header: (0, f.NW)({
                            numRequiredSignatures: (0, f.ai)(),
                            numReadonlySignedAccounts: (0, f.ai)(),
                            numReadonlyUnsignedAccounts: (0, f.ai)()
                        }),
                        instructions: (0, f.YO)((0, f.NW)({
                            accounts: (0, f.YO)((0, f.ai)()),
                            data: (0, f.Yj)(),
                            programIdIndex: (0, f.ai)()
                        })),
                        recentBlockhash: (0, f.Yj)(),
                        addressTableLookups: (0, f.lq)((0, f.YO)(tW))
                    })
                }),
                tP = (0, f.NW)({
                    pubkey: eW,
                    signer: (0, f.zM)(),
                    writable: (0, f.zM)(),
                    source: (0, f.lq)((0, f.KC)([(0, f.eu)("transaction"), (0, f.eu)("lookupTable")]))
                }),
                tE = (0, f.NW)({
                    accountKeys: (0, f.YO)(tP),
                    signatures: (0, f.YO)((0, f.Yj)())
                }),
                tN = (0, f.NW)({
                    parsed: (0, f.L5)(),
                ...
                tO = (0, f.KC)([(0, f.NW)({
                    ...
                    accounts: (0, f.YO)((0, f.Yj)()),
                    data: (0, f.Yj)(),
                    programId: (0, f.Yj)()
                })]),
                tL = (0, f.au)(tT, tO, e => "accounts" in e ? (0, f.vt)(e, tC) : (0, f.vt)(e, tN)),
                tq = (0, f.NW)({
                    signatures: (0, f.YO)((0, f.Yj)()),
                    message: (0, f.NW)({
                        accountKeys: (0, f.YO)(tP),
                        instructions: (0, f.YO)(tL),
                        recentBlockhash: (0, f.Yj)(),
                        addressTableLookups: (0, f.lq)((0, f.me)((0, f.YO)(tW)))
                    })
                }),
                tK = (0, f.NW)({
                    accountIndex: (0, f.ai)(),
                ...
                tY = (0, f.NW)({
                    ...
                    preBalances: (0, f.YO)((0, f.ai)()),
                    postBalances: (0, f.YO)((0, f.ai)()),
                    logMessages: (0, f.lq)((0, f.me)((0, f.YO)((0, f.Yj)()))),
                    preTokenBalances: (0, f.lq)((0, f.me)((0, f.YO)(tK))),
                    postTokenBalances: (0, f.lq)((0, f.me)((0, f.YO)(tK))),
                    loadedAddresses: (0, f.lq)(tz),
                    computeUnitsConsumed: (0, f.lq)((0, f.ai)())
                }),
                tR = (0, f.NW)({
                    err: eU,
                    fee: (0, f.ai)(),
                ...
                tj = (0, f.KC)([(0, f.eu)(0), (0, f.eu)("legacy")]),
                tH = (0, f.NW)({
                    pubkey: (0, f.Yj)(),
                    lamports: (0, f.ai)(),
                    postBalance: (0, f.me)((0, f.ai)()),
                    rewardType: (0, f.me)((0, f.Yj)()),
                    commission: (0, f.lq)((0, f.me)((0, f.ai)()))
                }),
                tD = eO((0, f.me)((0, f.NW)({
                    blockhash: (0, f.Yj)(),
                    ...
                    parentSlot: (0, f.ai)(),
                    transactions: (0, f.YO)((0, f.NW)({
                        transaction: tx,
                        meta: (0, f.me)(tY),
                        version: (0, f.lq)(tj)
                    })),
                    rewards: (0, f.lq)((0, f.YO)(tH)),
                    blockTime: (0, f.me)((0, f.ai)()),
                    blockHeight: (0, f.me)((0, f.ai)())
                }))),
                tM = eO((0, f.me)((0, f.NW)({
                    blockhash: (0, f.Yj)(),
                    previousBlockhash: (0, f.Yj)(),
                ...
                tQ = eL((0, f.NW)({
                    blockhash: (0, f.Yj)(),
                    lastValidBlockHeight: (0, f.ai)()
                })),
                t0 = eL((0, f.zM)()),
                t1 = (0, f.NW)({
                    slot: (0, f.ai)(),
                    numTransactions: (0, f.ai)(),
                    numSlots: (0, f.ai)(),
                    samplePeriodSecs: (0, f.ai)()
                }),
                t8 = eO((0, f.YO)(t1)),
                t3 = eL((0, f.me)((0, f.NW)({
                    feeCalculator: (0, f.NW)({
                        lamportsPerSignature: (0, f.ai)()
                    })
                }))),
                t2 = eO((0, f.Yj)()),
                t5 = eO((0, f.Yj)()),
            ...
            class t9 {
                constructor(e, t) {
                    ...
                    this._commitment = void 0, this._confirmTransactionInitialTimeout = void 0, this._rpcEndpoint = void 0, this._rpcWsEndpoint = void 0, this._rpcClient = void 0, this._rpcRequest = void 0, this._rpcBatchRequest = void 0, this._rpcWebSocket = void 0, this._rpcWebSocketConnected = !1, this._rpcWebSocketHeartbeat = null, this._rpcWebSocketIdleTimeout = null, this._rpcWebSocketGeneration = 0, this._disableBlockhashCaching = !1, this._pollingBlockhash = !1, this._blockhashInfo = {
                    ...
                    })(), t && "string" == typeof t ? this._commitment = t : t && (this._commitment = t.commitment, this._confirmTransactionInitialTimeout = t.confirmTransactionInitialTimeout, i = t.wsEndpoint, s = t.httpHeaders, n = t.fetch, a = t.fetchMiddleware, o = t.disableRetryOnRateLimit, c = t.httpAgent), this._rpcEndpoint = function(e) {
                        ...
                        let [r, i, s, n] = t, a = e.startsWith("https:") ? "wss:" : "ws:", o = null == s ? null : parseInt(s.slice(1), 10), c = null == o ? "" : `:${o+1}`;
                        return `${a}//${i}${c}${n}`
                    }(e), this._rpcClient = function(e, t, r, i, s, n) {
                        let a, o;
                        let c = r || eI;
                        return null != n && console.warn("You have supplied an `httpAgent` when creating a `Connection` in a browser environment.It has been ignored; `httpAgent` is only used in Node environments."), i && (o = async (e, t) => {
                            ...
                            try {
                                let t, r = 5,
                                    a = 500;
                                for (; t = o ? await o(e, n) : await c(e, n), 429 === t.status && !0 !== s && (r -= 1, 0 !== r);) {
                                    console.error(`Server responded with ${t.status} ${t.statusText}.  Retrying after ${a}ms delay...`), await ec(a), a *= 2
                                }
                                let l = await t.text();
                                t.ok ? i(null, l) : i(Error(`${t.status} ${t.statusText}: ${l}`))
                            } catch (e) {
                                e instanceof Error && i(e)
                            }
                        }, {})
                    }(e, s, n, a, o, c), this._rpcRequest = (r = this._rpcClient, (e, t) => new Promise((i, s) => {
                        r.request(e, t, (e, t) => {
                            if (e) {
                                s(e);
                                return
                    ...
                    }(this._rpcClient), this._rpcWebSocket = new ev(this._rpcWsEndpoint, {
                        autoconnect: !1,
                        max_reconnects: 1 / 0
                ...
                async getBalanceAndContext(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = this._buildArgs([e.toBase58()], r, void 0, i), n = await this._rpcRequest("getBalance", s), a = (0, f.vt)(n, eL((0, f.ai)()));
                    if ("error" in a) throw new ea(a.error, `failed to get balance for ${e.toBase58()}`);
                    return a.result
                }
                ...
                async getParsedTokenAccountsByOwner(e, t, r) {
                    ...
                    let s = this._buildArgs(i, r, "jsonParsed"),
                        ...
                        a = (0, f.vt)(n, tt);
                    if ("error" in a) throw new ea(a.error, `failed to get token accounts owned by account ${e.toBase58()}`);
                    return a.result
                }
                ...
                async getAccountInfoAndContext(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = this._buildArgs([e.toBase58()], r, "base64", i), n = await this._rpcRequest("getAccountInfo", s), a = (0, f.vt)(n, eL((0, f.me)(ti)));
                    if ("error" in a) throw new ea(a.error, `failed to get info about account ${e.toBase58()}`);
                    return a.result
                }
                async getParsedAccountInfo(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = this._buildArgs([e.toBase58()], r, "jsonParsed", i), n = await this._rpcRequest("getAccountInfo", s), a = (0, f.vt)(n, eL((0, f.me)(ta)));
                    if ("error" in a) throw new ea(a.error, `failed to get info about account ${e.toBase58()}`);
                    return a.result
                }
                ...
                async getMultipleParsedAccounts(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = e.map(e => e.toBase58()), n = this._buildArgs([s], r, "jsonParsed", i), a = await this._rpcRequest("getMultipleAccounts", n), o = (0, f.vt)(a, eL((0, f.YO)((0, f.me)(ta))));
                    if ("error" in o) throw new ea(o.error, `failed to get info for accounts ${s}`);
                    return o.result
                }
                async getMultipleAccountsInfoAndContext(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = e.map(e => e.toBase58()), n = this._buildArgs([s], r, "base64", i), a = await this._rpcRequest("getMultipleAccounts", n), o = (0, f.vt)(a, eL((0, f.YO)((0, f.me)(ti))));
                    if ("error" in o) throw new ea(o.error, `failed to get info for accounts ${s}`);
                    return o.result
                }
                ...
                async getStakeActivation(e, t, r) {
                    let {
                        commitment: i,
                        config: s
                    } = eE(t), n = this._buildArgs([e.toBase58()], i, void 0, { ...s,
                        epoch: null != r ? r : s ? .epoch
                    }), a = await this._rpcRequest("getStakeActivation", n), o = (0, f.vt)(a, eO(tc));
                    if ("error" in o) throw new ea(o.error, `failed to get Stake Activation ${e.toBase58()}`);
                    return o.result
                }
                async getProgramAccounts(e, t) {
                    let {
                        ...
                        encoding: s,
                        ...n
                    } = i || {}, a = this._buildArgs([e.toBase58()], r, s || "base64", { ...n,
                        ...n.filters ? {
                            filters: eN(n.filters)
                        } : null
                    }), o = await this._rpcRequest("getProgramAccounts", a), c = (0, f.YO)(ts), l = !0 === n.withContext ? (0, f.vt)(o, eL(c)) : (0, f.vt)(o, eO(c));
                    if ("error" in l) throw new ea(l.error, `failed to get accounts owned by program ${e.toBase58()}`);
                    return l.result
                }
                async getParsedProgramAccounts(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = this._buildArgs([e.toBase58()], r, "jsonParsed", i), n = await this._rpcRequest("getProgramAccounts", s), a = (0, f.vt)(n, eO((0, f.YO)(to)));
                    if ("error" in a) throw new ea(a.error, `failed to get accounts owned by program ${e.toBase58()}`);
                    return a.result
                }
                ...
                async confirmTransactionUsingBlockHeightExceedanceStrategy({
                    ...
                    let s, n = !1,
                        a = new Promise(t => {
                            ...
                            (async () => {
                                ...
                                if (!n) {
                                    for (; e <= r;)
                                        if (await ec(1e3), n || (e = await i(), n)) return;
                                    t({
                                        __type: J.BLOCKHEIGHT_EXCEEDED
                                    })
                                }
                            })()
                        }),
                    ...
                    try {
                        let e = await Promise.race([l, c, a]);
                ...
                async confirmTransactionUsingDurableNonceStrategy({
                            ...
                            (async () => {
                                if (n = await c(), !o)
                                    for (;;) {
                                        ...
                                        if (await ec(2e3), o || (n = await c(), o)) return
                                    }
                            })()
                        }),
                        {
                    ...
                    try {
                        let t = await Promise.race([d, u, c]);
                        if (t.__type === J.PROCESSED) a = t.response;
                            ...
                            if (i ? .value) {
                                ...
                                switch (t) {
                                    case "processed":
                                    case "recent":
                                        if ("processed" !== r && "confirmed" !== r && "finalized" !== r) throw new O(n);
                                        break;
                                    case "confirmed":
                                    case "single":
                                    case "singleGossip":
                                        if ("confirmed" !== r && "finalized" !== r) throw new O(n);
                                        break;
                                    case "finalized":
                                    case "max":
                                    case "root":
                                        if ("finalized" !== r) throw new O(n);
                                        break;
                                    default:
                                }
                                a = {
                ...
                async confirmTransactionUsingLegacyTimeoutStrategy({
                    ...
                    try {
                        ...
                        else throw new T(t, e.timeoutMs / 1e3)
                    } finally {
                        clearTimeout(r), n()
                    }
                    return i
                ...
                async getSlot(e) {
                    let {
                        commitment: t,
                        config: r
                    } = eE(e), i = this._buildArgs([], t, void 0, r), s = await this._rpcRequest("getSlot", i), n = (0, f.vt)(s, eO((0, f.ai)()));
                ...
                async getSlotLeader(e) {
                    let {
                        commitment: t,
                        config: r
                    } = eE(e), i = this._buildArgs([], t, void 0, r), s = await this._rpcRequest("getSlotLeader", i), n = (0, f.vt)(s, eO((0, f.Yj)()));
                ...
                async getTransactionCount(e) {
                    let {
                        commitment: t,
                        config: r
                    } = eE(e), i = this._buildArgs([], t, void 0, r), s = await this._rpcRequest("getTransactionCount", i), n = (0, f.vt)(s, eO((0, f.ai)()));
                ...
                async getInflationReward(e, t, r) {
                    let {
                        commitment: i,
                        config: s
                    } = eE(r), n = this._buildArgs([e.map(e => e.toBase58())], i, void 0, { ...s,
                        epoch: null != t ? t : s ? .epoch
                    }), a = await this._rpcRequest("getInflationReward", n), o = (0, f.vt)(a, eY);
                    if ("error" in o) throw new ea(o.error, "failed to get inflation reward");
                    return o.result
                }
                ...
                async getEpochInfo(e) {
                    let {
                        commitment: t,
                        config: r
                    } = eE(e), i = this._buildArgs([], t, void 0, r), s = await this._rpcRequest("getEpochInfo", i), n = (0, f.vt)(s, e8);
                ...
                async getEpochSchedule() {
                    ...
                    let r = t.result;
                    return new eS(r.slotsPerEpoch, r.leaderScheduleSlotOffset, r.warmup, r.firstNormalEpoch, r.firstNormalSlot)
                }
                ...
                async getLatestBlockhashAndContext(e) {
                    let {
                        commitment: t,
                        config: r
                    } = eE(e), i = this._buildArgs([], t, void 0, r), s = await this._rpcRequest("getLatestBlockhash", i), n = (0, f.vt)(s, tQ);
                ...
                async isBlockhashValid(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = this._buildArgs([e], r, void 0, i), n = await this._rpcRequest("isBlockhashValid", s), a = (0, f.vt)(n, t0);
                    if ("error" in a) throw new ea(a.error, "failed to determine if the blockhash `" + e + "`is valid");
                    return a.result
                }
                async getVersion() {
                ...
                async getBlock(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = this._buildArgsAtLeastConfirmed([e], r, void 0, i), n = await this._rpcRequest("getBlock", s);
                    try {
                ...
                async getParsedBlock(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = this._buildArgsAtLeastConfirmed([e], r, "jsonParsed", i), n = await this._rpcRequest("getBlock", s);
                    try {
                        switch (i ? .transactionDetails) {
                            case "accounts":
                                {
                ...
                async getTransaction(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = this._buildArgsAtLeastConfirmed([e], r, void 0, i), n = await this._rpcRequest("getTransaction", s), a = (0, f.vt)(n, tX);
                    if ("error" in a) throw new ea(a.error, "failed to get transaction");
                    let o = a.result;
                    return o ? { ...o,
                        transaction: { ...o.transaction,
                            message: eK(o.version, o.transaction.message)
                        }
                    } : o
                }
                async getParsedTransaction(e, t) {
                    let {
                        commitment: r,
                        config: i
                    } = eE(t), s = this._buildArgsAtLeastConfirmed([e], r, "jsonParsed", i), n = await this._rpcRequest("getTransaction", s), a = (0, f.vt)(n, tZ);
                    if ("error" in a) throw new ea(a.error, "failed to get transaction");
                    return a.result
                }
                    ...
                    return (await this._rpcBatchRequest(s)).map(e => {
                        ...
                        return r ? { ...r,
                            transaction: { ...r.transaction,
                                message: eK(r.version, r.transaction.message)
                            }
                        } : r
                    })
                }
                ...
                async getAddressLookupTable(e, t) {
                    ...
                    return null !== i && (s = new e_({
                        key: e,
                        state: e_.deserialize(i.data)
                    })), {
                        context: r,
                        value: s
                    }
                ...
                async getNonceAndContext(e, t) {
                    ...
                    return null !== i && (s = eg.fromAccountData(i.data)), {
                        context: r,
                        value: s
                    }
                }
                ...
                async _blockhashWithExpiryBlockHeight(e) {
                    if (!e) {
                        for (; this._pollingBlockhash;) await ec(100);
                ...
                async getStakeMinimumDelegation(e) {
                    let {
                        commitment: t,
                        config: r
                    } = eE(e), i = this._buildArgs([], t, "base64", r), s = await this._rpcRequest("getStakeMinimumDelegation", i), n = (0, f.vt)(s, eL((0, f.ai)()));
                ...
                async simulateTransaction(e, t, r) {
                    ...
                    if ("message" in e) {
                        let i = e.serialize(),
                            s = a.Buffer.from(i).toString("base64");
                        if (Array.isArray(t) || void 0 !== r) throw Error("Invalid arguments");
                        let n = t || {};
                        n.encoding = "base64", "commitment" in n || (n.commitment = this.commitment), t && "object" == typeof t && "innerInstructions" in t && (n.innerInstructions = t.innerInstructions);
                        let o = [s, n],
                    ...
                    if (e instanceof Z ? ((i = new Z).feePayer = e.feePayer, i.instructions = e.instructions, i.nonceInfo = e.nonceInfo, i.signatures = e.signatures) : (i = Z.populate(e))._message = i._json = void 0, void 0 !== t && !Array.isArray(t)) throw Error("Invalid arguments");
                    ...
                    let s = i._compile(),
                        n = s.serialize(),
                        o = i._serialize(n).toString("base64"),
                        c = {
                            encoding: "base64",
                            commitment: this.commitment
                        };
                    ...
                    }), t && (c.sigVerify = !0), t && "object" == typeof t && "innerInstructions" in t && (c.innerInstructions = t.innerInstructions);
                    let l = [o, c],
                        u = await this._rpcRequest("simulateTransaction", l),
                        d = (0, f.vt)(u, eX);
                    if ("error" in d) {
                        let e;
                ...
                async sendEncodedTransaction(e, t) {
                    ...
                    if ("error" in o) {
                        let e;
                        throw "data" in o.error && (e = o.error.data.logs), new en({
                            ...
                            case "unsubscribed":
                                ...
                                await (async () => {
                                    ...
                                    try {
                                        ...
                                        if (console.error(`Received ${n instanceof Error?"":"JSON-RPC "}error calling \`${s}\``, {
                                                args: i,
                                                error: n
                                            }), !t()) return;
                                        this._setSubscription(e, { ...r,
                ...
                onAccountChange(e, t, r) {
                    let {
                        commitment: i,
                        config: s
                    } = eE(r), n = this._buildArgs([e.toBase58()], i || this._commitment || "finalized", "base64", s);
                ...
                onProgramAccountChange(e, t, r, i) {
                    let {
                        commitment: s,
                        config: n
                    } = eE(r), a = this._buildArgs([e.toBase58()], s || this._commitment || "finalized", "base64", n || (i ? {
                        filters: eN(i)
                    } : void 0));
                    return this._makeSubscription({
                        callback: t,
                ...
                onSignatureWithOptions(e, t, r) {
                    ...
                    }, n = this._buildArgs([e], i, void 0, s), a = this._makeSubscription({
                        callback: (e, r) => {
                            t(e, r);
                            try {
            ...
            class re {
                ...
                static fromSeed(e) {
                    let t = v(e),
                        r = new Uint8Array(64);
                    return r.set(e), r.set(t, 32), new re({
                        publicKey: t,
                        secretKey: r
                    })
                }
                get publicKey() {
                    return new N(this._keypair.publicKey)
                }
                get secretKey() {
            ...
            let rt = Object.freeze({
                CreateLookupTable: {
                    index: 0,
                    layout: p.w3([p.DH("instruction"), em("recentSlot"), p.u8("bumpSeed")])
                },
                FreezeLookupTable: {
                    index: 1,
                    layout: p.w3([p.DH("instruction")])
                ...
                ExtendLookupTable: {
                    index: 2,
                    layout: p.w3([p.DH("instruction"), em(), p.O6(q(), p.cY(p.DH(), -8), "addresses")])
                },
            ...
            class rr {
                ...
                static createLookupTable(e) {
                    let [t, r] = N.findProgramAddressSync([e.authority.toBuffer(), (0, m.Bq)(BigInt(e.recentSlot), 8)], this.programId), i = el(rt.CreateLookupTable, {
                ...
                static deactivateLookupTable(e) {
                    let t = el(rt.DeactivateLookupTable),
                        r = [{
                            pubkey: e.lookupTable,
                            isSigner: !1,
                            isWritable: !0
            ...
            rr.programId = new N("AddressLookupTab1e1111111111111111111111111");
            let ri = Object.freeze({
                RequestUnits: {
                    index: 0,
                    layout: p.w3([p.u8("instruction"), p.DH("units"), p.DH("additionalFee")])
                },
                RequestHeapFrame: {
                    index: 1,
                    layout: p.w3([p.u8("instruction"), p.DH("bytes")])
                },
                SetComputeUnitLimit: {
                    index: 2,
                    layout: p.w3([p.u8("instruction"), p.DH("units")])
                },
                SetComputeUnitPrice: {
                    index: 3,
                    layout: p.w3([p.u8("instruction"), em("microLamports")])
                }
            });
            class rs {
                constructor() {}
                static requestUnits(e) {
                    let t = el(ri.RequestUnits, e);
                    return new X({
                        keys: [],
                        programId: this.programId,
                        data: t
                ...
                static requestHeapFrame(e) {
                    let t = el(ri.RequestHeapFrame, e);
                    return new X({
                        keys: [],
                        programId: this.programId,
                        data: t
                ...
                static setComputeUnitLimit(e) {
                    let t = el(ri.SetComputeUnitLimit, e);
                    return new X({
                        keys: [],
                        programId: this.programId,
                        data: t
                ...
                static setComputeUnitPrice(e) {
                    let t = el(ri.SetComputeUnitPrice, {
            ...
            rs.programId = new N("ComputeBudget111111111111111111111111111111");
            let rn = p.w3([p.u8("numSignatures"), p.u8("padding"), p.NX("signatureOffset"), p.NX("signatureInstructionIndex"), p.NX("publicKeyOffset"), p.NX("publicKeyInstructionIndex"), p.NX("messageDataOffset"), p.NX("messageDataSize"), p.NX("messageInstructionIndex")]);
            class ra {
                constructor() {}
                static createInstructionWithPublicKey(e) {
                    ...
                    }, l), l.fill(t, n), l.fill(i, o), l.fill(r, c), new X({
                        keys: [],
            ...
            ra.programId = new N("Ed25519SigVerify111111111111111111111111111");
            let ro = (e, t) => {
                let r = S.bI.sign(e, t);
                return [r.toCompactRawBytes(), r.recovery]
            };
            S.bI.utils.isValidPrivateKey;
            let rc = S.bI.getPublicKey,
                rl = p.w3([p.u8("numSignatures"), p.NX("signatureOffset"), p.u8("signatureInstructionIndex"), p.NX("ethAddressOffset"), p.u8("ethAddressInstructionIndex"), p.NX("messageDataOffset"), p.NX("messageDataSize"), p.u8("messageInstructionIndex"), p.av(20, "ethAddress"), p.av(64, "signature"), p.u8("recoveryId")]);
            class ru {
                constructor() {}
                static publicKeyToEthAddress(e) {
                    j(64 === e.length, `Public key must be 64 bytes but received ${e.length} bytes`);
                    try {
                        return a.Buffer.from((0, k.lY)(W(e))).slice(-20)
                    } catch (e) {
                ...
                static createInstructionWithPublicKey(e) {
                    ...
                    return ru.createInstructionWithEthAddress({
                        ethAddress: ru.publicKeyToEthAddress(t),
                        message: r,
                        signature: i,
                        recoveryId: s,
                        instructionIndex: n
                ...
                static createInstructionWithEthAddress(e) {
                    ...
                    j(20 === (t = "string" == typeof r ? r.startsWith("0x") ? a.Buffer.from(r.substr(2), "hex") : a.Buffer.from(r, "hex") : r).length, `Address must be 20 bytes but received ${t.length} bytes`);
                    let c = 12 + t.length,
                        l = c + s.length + 1,
                        u = a.Buffer.alloc(rl.span + i.length);
                    return rl.encode({
                        numSignatures: 1,
                        signatureOffset: c,
                        ...
                        ethAddress: W(t),
                        recoveryId: n
                    }, u), u.fill(W(i), rl.span), new X({
                        keys: [],
                        programId: ru.programId,
                        data: u
                    })
                }
                static createInstructionWithPrivateKey(e) {
            ...
            ru.programId = new N("KeccakSecp256k11111111111111111111111111111");
            let rd = new N("StakeConfig11111111111111111111111111111111");
            class rh {
                constructor(e, t, r) {
                    this.unixTimestamp = void 0, this.epoch = void 0, this.custodian = void 0, this.unixTimestamp = e, this.epoch = t, this.custodian = r
                }
            }
            rh.default = new rh(0, 0, N.default);
            let rg = Object.freeze({
                Initialize: {
                    index: 0,
                    layout: p.w3([p.DH("instruction"), ((e = "authorized") => p.w3([q("staker"), q("withdrawer")], e))(), ((e = "lockup") => p.w3([p.Wg("unixTimestamp"), p.Wg("epoch"), q("custodian")], e))()])
                },
                Authorize: {
                    index: 1,
                    layout: p.w3([p.DH("instruction"), q("newAuthorized"), p.DH("stakeAuthorizationType")])
                },
                Delegate: {
                    index: 2,
                    layout: p.w3([p.DH("instruction")])
                ...
                AuthorizeWithSeed: {
                    index: 8,
                    layout: p.w3([p.DH("instruction"), q("newAuthorized"), p.DH("stakeAuthorizationType"), z("authoritySeed"), q("authorityOwner")])
                }
            });
            Object.freeze({
                Staker: {
            ...
            class rp {
                ...
                static initialize(e) {
                    let {
                        ...
                        authorized: r,
                        lockup: i
                    } = e, s = i || rh.default, n = el(rg.Initialize, {
                        authorized: {
                            staker: W(r.staker.toBuffer()),
                            withdrawer: W(r.withdrawer.toBuffer())
                        },
                        lockup: {
                            unixTimestamp: s.unixTimestamp,
                            epoch: s.epoch,
                            custodian: W(s.custodian.toBuffer())
                        }
                    });
                    return new X({
                        keys: [{
                ...
                static createAccountWithSeed(e) {
                    let t = new Z;
                    t.add(eb.createAccountWithSeed({
                        fromPubkey: e.fromPubkey,
                ...
                static authorizeWithSeed(e) {
                    let {
                        ...
                        custodianPubkey: o
                    } = e, c = el(rg.AuthorizeWithSeed, {
                        newAuthorized: W(n.toBuffer()),
                        stakeAuthorizationType: a.index,
                        authoritySeed: i,
                        authorityOwner: W(s.toBuffer())
                    }), l = [{
                        pubkey: t,
                        isSigner: !1,
                        isWritable: !0
                ...
                static splitWithSeed(e, t) {
                    ...
                    return c.add(eb.allocate({
                        accountPubkey: s,
                        basePubkey: n,
                        seed: a,
                        space: this.space,
                        programId: this.programId
                    })), t && t > 0 && c.add(eb.transfer({
                        fromPubkey: e.authorizedPubkey,
                        toPubkey: s,
                        lamports: t
            ...
            rp.programId = new N("Stake11111111111111111111111111111111111111"), rp.space = 200;
            let rm = Object.freeze({
                InitializeAccount: {
                    index: 0,
                    layout: p.w3([p.DH("instruction"), ((e = "voteInit") => p.w3([q("nodePubkey"), q("authorizedVoter"), q("authorizedWithdrawer"), p.u8("commission")], e))()])
                },
                Authorize: {
                    index: 1,
                    layout: p.w3([p.DH("instruction"), q("newAuthorized"), p.DH("voteAuthorizationType")])
                },
                Withdraw: {
                    index: 3,
                    layout: p.w3([p.DH("instruction"), p.Wg("lamports")])
                ...
                AuthorizeWithSeed: {
                    index: 10,
                    layout: p.w3([p.DH("instruction"), ((e = "voteAuthorizeWithSeedArgs") => p.w3([p.DH("voteAuthorizationType"), q("currentAuthorityDerivedKeyOwnerPubkey"), z("currentAuthorityDerivedKeySeed"), q("newAuthorized")], e))()])
                }
            });
            Object.freeze({
                Voter: {
            ...
            class rf {
                ...
                static initializeAccount(e) {
                    let {
                        ...
                        nodePubkey: r,
                        voteInit: i
                    } = e, s = el(rm.InitializeAccount, {
                        voteInit: {
                            nodePubkey: W(i.nodePubkey.toBuffer()),
                            authorizedVoter: W(i.authorizedVoter.toBuffer()),
                            authorizedWithdrawer: W(i.authorizedWithdrawer.toBuffer()),
                ...
                static authorizeWithSeed(e) {
                    let {
                        ...
                        votePubkey: a
                    } = e, o = el(rm.AuthorizeWithSeed, {
                        voteAuthorizeWithSeedArgs: {
                            currentAuthorityDerivedKeyOwnerPubkey: W(r.toBuffer()),
                            currentAuthorityDerivedKeySeed: i,
                            newAuthorized: W(s.toBuffer()),
                ...
                static updateValidatorIdentity(e) {
                    let {
                        ...
                        authorizedWithdrawerPubkey: r,
                        nodePubkey: i
                    } = e, s = el(rm.UpdateValidatorIdentity);
                    return new Z().add({
                        keys: [{
                            pubkey: t,
                            isSigner: !1,
