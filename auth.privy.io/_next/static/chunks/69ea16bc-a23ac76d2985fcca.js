            ...
            ! function() {
                var e, f, a, o, s, h, c, d = {
                        ...
                        9807: function(t, e, r) {
                            ...
                            t.exports = function(t, e, r, n, l) {
                                ...
                                t = i.concat([l, t]);
                                for (var p = b.modulus.byteLength(), m = [0, 1]; t.length + m.length + 1 < p;) m.push(255);
                                m.push(0);
                        ...
                        4013: function(t, e, r) {
                            ...
                            t.exports = function(t, e, r, h, c) {
                                ...
                                k = i.from(k);
                                var R = n.mont(M.modulus);
                                t = (t = new n(t).toRed(R)).redPow(new n(M.publicExponent));
                                var I = +(E < 8);
                                for (S = Math.min((t = i.from(t.fromRed().toArray())).length, k.length), t.length !== k.length && (I = 1), A = -1; ++A < S;) I |= t[A] ^ k[A];
                                return 0 === I
                            }
                        },
                        4734: function(t) {
                        ...
                        4088: function(t, e, r) {
                            ...
                            t.exports = d, d.prototype.keyPair = function(t) {
                                ...
                                for (var a = this.n.byteLength(), o = e.getPrivate().toArray("be", a), s = t.toArray("be", a), h = new n({
                                    ...
                                    if (!(0 >= (l = this._truncateToN(l, !0)).cmpn(1) || l.cmp(d) >= 0)) {
                                        var b = this.g.mul(l);
                                        if (!b.isInfinity()) {
                                            var p = b.getX(),
                                                m = p.umod(this.n);
                        ...
                        9029: function(t, e, r) {
                            ...
                            r(3782)(f, n), f.prototype._transform = function(t, e, r) {
                                ...
                                for (var r = this._block, n = 0; this._blockOffset + t.length - n >= this._blockSize;) {
                                    for (var f = this._blockOffset; f < this._blockSize;) r[f++] = t[n++];
                                    this._update(), this._blockOffset = 0
                                }
                                for (; n < t.length;) r[this._blockOffset++] = t[n++];
                                for (var a = 0, o = 8 * t.length; o > 0; ++a) this._length[a] += o, (o = this._length[a] / 0x100000000 | 0) > 0 && (this._length[a] -= 0x100000000 * o);
                                return this
                        ...
                        9601: function(t, e, i) {
                            ...
                            t.exports = function(t, e, i, p, m, v) {
                                ...
                                ! function(t, e) {
                                    ...
                                    return r ? b(t, e, i, p, y) : h(t, e, i, p, m)
                                }), v)
                            }
                        },
                        7007: function(t) {
                        ...
                        4366: function(t, e, r) {
                            ...
                            t.exports = function(t, e, r) {
                                ...
                                if (1 === u) return function(t, e, r) {
                                    for (var i = e.slice(0, 2), n = 2, f = 0; 0 !== e[n++];)
                                        if (n >= e.length) {
                                            f++;
                                            break
                                        }
                                    var a = e.slice(2, n - 1);
                                    if (("0002" !== i.toString("hex") && !r || "0001" !== i.toString("hex") && r) && f++, a.length < 8 && f++, f) throw Error("decryption error");
                                    return e.slice(n)
                                }(0, d, r);
                                if (3 === u) return d;
                        ...
                        1709: function(t, e, i) {
                            ...
                            function I(t, e) {
                                ...
                                if (t > e.highWaterMark) {
                                    var r;
                                    (r = t) >= 0x40000000 ? r = 0x40000000 : (r--, r |= r >>> 1, r |= r >>> 2, r |= r >>> 4, r |= r >>> 8, r |= r >>> 16, r++), e.highWaterMark = r
                                }
                        ...
                        8442: function(t, e, r) {
                            ...
                            t.exports = function() {
                                ...
                                var l = c.map(function(t, n) {
                                    var f, o, h, d, b, p = n < c.length - 1;
                                    return o = f = function(t) {
                                            e || (e = t), t && l.forEach(s), p || (l.forEach(s), u(e))
                                        }, h = !1, f = function() {
                ...
                function l(t) {
                    ...
                    var r = u[t] = {
                        ...
                        i = !0;
                    try {
                        d[t].call(r.exports, r, r.exports, l), i = !1
                    } finally {
                        i && delete u[t]
                    }
                ...
                var b = {};
                b.randomBytes = b.rng = b.pseudoRandomBytes = b.prng = l(7223), b.createHash = b.Hash = l(9739), b.createHmac = b.Hmac = l(4873), e = ["sha1", "sha224", "sha256", "sha384", "sha512", "md5", "rmd160"].concat(Object.keys(l(9276))), b.getHashes = function() {
                    return e
                }, b.pbkdf2 = (f = l(4978)).pbkdf2, b.pbkdf2Sync = f.pbkdf2Sync, b.Cipher = (a = l(8996)).Cipher, b.createCipher = a.createCipher, b.Cipheriv = a.Cipheriv, b.createCipheriv = a.createCipheriv, b.Decipher = a.Decipher, b.createDecipher = a.createDecipher, b.Decipheriv = a.Decipheriv, b.createDecipheriv = a.createDecipheriv, b.getCiphers = a.getCiphers, b.listCiphers = a.listCiphers, b.DiffieHellmanGroup = (o = l(6587)).DiffieHellmanGroup, b.createDiffieHellmanGroup = o.createDiffieHellmanGroup, b.getDiffieHellman = o.getDiffieHellman, b.createDiffieHellman = o.createDiffieHellman, b.DiffieHellman = o.DiffieHellman, b.createSign = (s = l(4078)).createSign, b.Sign = s.Sign, b.createVerify = s.createVerify, b.Verify = s.Verify, b.createECDH = l(9942), b.publicEncrypt = (h = l(9783)).publicEncrypt, b.privateEncrypt = h.privateEncrypt, b.publicDecrypt = h.publicDecrypt, b.privateDecrypt = h.privateDecrypt, b.randomFill = (c = l(6445)).randomFill, b.randomFillSync = c.randomFillSync, b.createCredentials = function() {
