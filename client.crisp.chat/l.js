        ...
        new(function() {
            function t() {
                ...
                try {
                    this.ns = "CrispLoader", this.n = {
                        ...
                        log: function(t, i) {},
                        debug: function(t, i) {}
                    }, this.s = !1, this.f = "crisp-client", this.y = "client.crisp.chat", this.w = "client.relay.crisp.chat", this.v = "stream.relay.crisp.chat", this.x = "71d3864", this.on = "production", this.fn = "https:", this._n = "https://crisp.chat", this.fs = "https://go.crisp.chat", this.ms = "https://image.crisp.chat", this.ws = "https://game.crisp.chat", this.$s = "".concat(this.fn, "//").concat(this.w), this._e = "".concat(this.fn, "//").concat(this.v), this.io = "".concat(this.fn, "//").concat(this.y), this.do = [{
            ...
            return i.init = function() {
                var t, i, n, s = this,
                    e = "init";
                try {
                    this._p || !0 === this.mp || this.yp(), this._p && !0 !== this.mp && (this.mp = !0, (t = document.createElement("div")).id = "crisp-loader", document.getElementsByTagName("body")[0].appendChild(t), i = function() {
                        return "none" === window.getComputedStyle(t).getPropertyValue("display")
                    }, (n = function() {
                        s.wp = setTimeout(function() {
                            s.wp = null, s.Ip -= s.ep, void 0 !== window[s.np] && "function" == typeof window[s.np].__init && !0 === i() ? (s.n.info("".concat(s.ns, ".").concat(e), "Dependencies loaded"), t.parentNode.removeChild(t), window[s.np].__init({
                            ...
                            })) : 0 < s.Ip ? n() : s.n.error("".concat(s.ns, ".").concat(e), "Could not load dependencies")
                        }, s.ep)
                    })())
                } catch (t) {}
            }, i.reset = function() {
                ...
                this.mp = !1, this.wp = null, this.Ip = this.rp, this.vp = document.domain, this.Rp = document.location.href, this.Ep = document.location.hostname, this.Sp = window.navigator.userAgent, this.bp = (new Date).getTimezoneOffset(), this.Dp = this.Up(), this.Tp = this.Lp()
            }, i.yp = function() {
                "string" == typeof CRISP_WEBSITE_ID && CRISP_WEBSITE_ID ? this._p = CRISP_WEBSITE_ID : this._p = this.Mp(), "string" == typeof CRISP_TOKEN_ID && CRISP_TOKEN_ID ? this.gp = CRISP_TOKEN_ID : "number" == typeof CRISP_TOKEN_ID && CRISP_TOKEN_ID ? this.gp = CRISP_TOKEN_ID.toString() : this.gp = null, "number" == typeof CRISP_COOKIE_EXPIRE && 0 < CRISP_COOKIE_EXPIRE ? this.Gi = CRISP_COOKIE_EXPIRE : this.Gi = null, "string" == typeof CRISP_COOKIE_DOMAIN && CRISP_COOKIE_DOMAIN ? this.Cp = CRISP_COOKIE_DOMAIN : this.Cp = null, "function" == typeof CRISP_READY_TRIGGER ? this.Op = CRISP_READY_TRIGGER : this.Op = {}, "object" == typeof CRISP_RUNTIME_CONFIG ? this.Np = CRISP_RUNTIME_CONFIG : this.Np = {}, "object" == typeof CRISP_INCLUDE_ATTRS ? this.Yp = CRISP_INCLUDE_ATTRS : this.Yp = {}
            }, i.Bp = function() {
                try {
