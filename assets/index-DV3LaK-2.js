...
const P = {
        ...
        getPriceImpact({
            ...
            const i = l.bigNumber(o).times(t),
                r = l.bigNumber(s).times(n);
        ...
        getToTokenAmount({
            ...
            const r = o.decimals,
                ...
                d = s;
            if (d <= 0) return "0";
            const T = l.bigNumber(i).times(.0085),
    ...
    N = {
        ...
        getParams() {
            var c, d, T, m, f, w, b, I;
            const o = h.state.activeCaipAddress,
                t = W.getPlainAddress(o),
                n = Q(),
                s = K.getConnectorId(h.state.activeChain);
            if (!t) throw new Error("No address found to swap the tokens from.");
            const i = !((c = e.toToken) != null && c.address) || !((d = e.toToken) != null && d.decimals),
                r = !((T = e.sourceToken) != null && T.address) || !((m = e.sourceToken) != null && m.decimals) || !l.bigNumber(e.sourceTokenAmount).gt(0),
        ...
        switchTokens() {
            ...
            const o = e.toToken ? { ...e.toToken
                } : void 0,
                t = e.sourceToken ? { ...e.sourceToken
                } : void 0,
                n = o && e.toTokenAmount === "" ? "1" : e.toTokenAmount;
        ...
        resetValues() {
            ...
            const {
                networkAddress: o
            } = a.getParams(), t = (n = e.tokens) == null ? void 0 : n.find(s => s.address === o);
        ...
        async initializeState() {
            if (!e.initializing) {
                if (e.initializing = !0, !e.initialized) try {
        ...
        async getAddressPrice(o) {
            ...
            const n = await y.fetchTokenPrice({
                ...
                s = (n == null ? void 0 : n.fungibles) || [],
                i = [...e.tokens || [], ...e.myTokensWithBalance || []],
                r = (d = i == null ? void 0 : i.find(m => m.address === o)) == null ? void 0 : d.symbol,
                u = ((T = s.find(m => m.symbol.toLowerCase() === (r == null ? void 0 : r.toLowerCase()))) == null ? void 0 : T.price) || 0,
        ...
        async getNetworkTokenPrice() {
            ...
            const {
                networkAddress: o
            } = a.getParams(), n = (i = (await y.fetchTokenPrice({
                addresses: [o]
            }).catch(() => (g.showError("Failed to fetch network token price"), {
                fungibles: []
            }))).fungibles) == null ? void 0 : i[0], s = (n == null ? void 0 : n.price.toString()) || "0";
        ...
        async getMyTokensWithBalance(o) {
            const t = await q.getMyTokensWithBalance(o),
                n = C.mapBalancesToSwapTokens(t);
            n && (await a.getInitialGasPrice(), a.setBalances(n))
        },
        setBalances(o) {
            const {
                networkAddress: t
            } = a.getParams(), n = h.state.activeCaipNetwork;
            if (!n) return;
        ...
        async getInitialGasPrice() {
            ...
            switch ((n = (t = h.state) == null ? void 0 : t.activeCaipNetwork) == null ? void 0 : n.chainNamespace) {
                ...
                case S.CHAIN.EVM:
                default:
                    const s = o.standard ? ? "0",
                        i = BigInt(s),
                        r = BigInt(R),
                        u = P.getGasPriceInUSD(e.networkPrice, r, i);
                    return e.gasFee = s, e.gasPriceInUSD = u, {
                        gasPrice: i,
                        gasPriceInUSD: u
                    }
            }
        ...
        async swapTokens() {
            var r, u;
            const o = H.state.address,
                t = e.sourceToken,
                n = e.toToken,
                s = l.bigNumber(e.sourceTokenAmount).gt(0);
            if (s || a.setToTokenAmount(""), !n || !t || e.loadingPrices || !s) return;
            e.loadingQuote = !0;
        ...
        async getTransaction() {
            const {
                fromCaipAddress: o,
                availableToSwap: t
            } = a.getParams(), n = e.sourceToken, s = e.toToken;
            if (!(!o || !t || !n || !s || e.loadingQuote)) try {
        ...
        async createSwapTransaction() {
            ...
            const {
                ...
                fromCaipAddress: t,
                sourceTokenAmount: n
            } = a.getParams(), s = e.sourceToken, i = e.toToken;
            if (!t || !n || !s || !i) return;
            ...
            try {
                const c = await y.generateSwapCalldata({
                    ...
                    f = W.getPlainAddress(c.tx.to);
                if (!f) throw new Error("SwapController:createSwapTransaction - address is required");
                const w = {
                    data: c.tx.data,
                    to: f,
                    gas: T,
        ...
        async sendTransactionForSwap(o) {
            ...
            const i = `Swapping ${(u=e.sourceToken)==null?void 0:u.symbol} to ${l.formatNumberToLocalString(n,3)} ${(c=e.toToken)==null?void 0:c.symbol}`,
                r = `Swapped ${(d=e.sourceToken)==null?void 0:d.symbol} to ${l.formatNumberToLocalString(n,3)} ${(T=e.toToken)==null?void 0:T.symbol}`;
            ...
            try {
                const D = [(m = e.sourceToken) == null ? void 0 : m.address, (f = e.toToken) == null ? void 0 : f.address].join(","),
...
var _ = function(o, t, n, s) {
    var i = arguments.length,
        r = i < 3 ? t : s === null ? s = Object.getOwnPropertyDescriptor(t, n) : s,
        u;
    if (typeof Reflect == "object" && typeof Reflect.decorate == "function") r = Reflect.decorate(o, t, n, s);
    else
        for (var c = o.length - 1; c >= 0; c--)(u = o[c]) && (r = (i < 3 ? u(r) : i > 3 ? u(t, n, r) : u(t, n)) || r);
...
v.styles = [X, Z, se];
_([z()], v.prototype, "imageSrc", void 0);
_([z()], v.prototype, "text", void 0);
v = _([ne("wui-token-button")], v);
export {
    a as S
};