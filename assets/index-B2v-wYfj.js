...
var u = function(a, e, r, i) {
    var l = arguments.length,
        o = l < 3 ? e : i === null ? i = Object.getOwnPropertyDescriptor(e, r) : i,
        c;
    if (typeof Reflect == "object" && typeof Reflect.decorate == "function") o = Reflect.decorate(a, e, r, i);
    else
        for (var s = a.length - 1; s >= 0; s--)(c = a[s]) && (o = (l < 3 ? c(o) : l > 3 ? c(e, r, o) : c(e, r)) || o);
...
n.styles = [f, w, b];
u([t()], n.prototype, "tokenName", void 0);
u([t()], n.prototype, "tokenImageUrl", void 0);
u([t({
    type: Number
})], n.prototype, "tokenValue", void 0);
u([t()], n.prototype, "tokenAmount", void 0);
u([t()], n.prototype, "tokenCurrency", void 0);
u([t({
    type: Boolean
})], n.prototype, "clickable", void 0);
n = u([x("wui-list-token")], n);
const y = h `
  :host {
    display: block;
...
let d = class extends p {
    ...
    visualTemplate() {
        if (this.imageSrc) return this.dataset.variant = "image", m `<wui-image src=${this.imageSrc} alt=${this.alt??"avatar"}></wui-image>`;
        if (this.address) {
