...
import {
    n as J,
    s as Q
} from "./ConstantsUtil-Dmg8YACJ.js";
import "./index-DccHHNeF.js";
import {
    S as L
} from "./index-DV3LaK-2.js";
...
var E = function(o, e, i, n) {
    ...
    if (typeof Reflect == "object" && typeof Reflect.decorate == "function") t = Reflect.decorate(o, e, i, n);
        ...
        for (var a = o.length - 1; a >= 0; a--)(s = o[a]) && (t = (r < 3 ? s(t) : r > 3 ? s(e, i, t) : s(e, i)) || t);
...
${this.value??""}</textarea
    ...
    async toggleInstructionFocus(e) {
        this.instructionElementRef.value && await this.instructionElementRef.value.animate([{
            opacity: e ? 0 : 1
        }, {
            opacity: e ? 1 : 0
        }], {
...
A.styles = X;
E([d()], A.prototype, "value", void 0);
E([c()], A.prototype, "instructionHidden", void 0);
E([c()], A.prototype, "pasting", void 0);
A = E([m("w3m-input-address")], A);
const Z = f `
  :host {
    position: relative;
...
let C = class extends w {
    ...
    dispatchInputChangeEvent(e) {
        ...
        if (i && ((n = this.inputElementRef) != null && n.value))
            ...
            } else J.test(i) || (this.inputElementRef.value.value = this.value.replace(new RegExp(i.replace(Q, "\\$&"), "gu"), ""));
...
h.styles = te;
$([c()], h.prototype, "token", void 0);
$([c()], h.prototype, "sendTokenAmount", void 0);
$([c()], h.prototype, "receiverAddress", void 0);
$([c()], h.prototype, "receiverProfileName", void 0);
$([c()], h.prototype, "loading", void 0);
$([c()], h.prototype, "message", void 0);
h = $([m("w3m-wallet-send-view")], h);
const ie = f `
  .contentContainer {
    height: 440px;
    overflow: scroll;
...
T.styles = [z, W, re];
j([d()], T.prototype, "imageSrc", void 0);
j([d()], T.prototype, "textTitle", void 0);
j([d()], T.prototype, "textValue", void 0);
T = j([m("wui-list-content")], T);
const oe = f `
  :host {
    display: flex;
    width: auto;
    ...
    async onSendClick() {
        ...
        try {
            ...
            Y.sendEvent({
                ...
                properties: {
                    message: r,
                    isSmartAccount: K(x.state.activeChain) === G.ACCOUNT_TYPES.SMART_ACCOUNT,
...
p.styles = se;
v([c()], p.prototype, "token", void 0);
v([c()], p.prototype, "sendTokenAmount", void 0);
v([c()], p.prototype, "receiverAddress", void 0);
v([c()], p.prototype, "receiverProfileName", void 0);
v([c()], p.prototype, "receiverProfileImageUrl", void 0);
v([c()], p.prototype, "caipNetwork", void 0);
v([c()], p.prototype, "loading", void 0);
p = v([m("w3m-wallet-send-preview-view")], p);
export {
    k as W3mSendSelectTokenView, p as W3mWalletSendPreviewView, h as W3mWalletSendView
};