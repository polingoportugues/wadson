...
var ge = function(n, e, t, i) {
    ...
    if (typeof Reflect == "object" && typeof Reflect.decorate == "function") o = Reflect.decorate(n, e, t, i);
        ...
        for (var r = n.length - 1; r >= 0; r--)(s = n[r]) && (o = (a < 3 ? s(o) : a > 3 ? s(e, t, o) : s(e, t)) || o);
...
S.styles = [j, ve];
I([u()], S.prototype, "message", void 0);
I([u()], S.prototype, "backgroundColor", void 0);
I([u()], S.prototype, "iconColor", void 0);
I([u()], S.prototype, "icon", void 0);
S = I([b("wui-alertbar")], S);
const ye = y `
  :host {
    display: block;
    position: absolute;
...
_.styles = ye;
te([d()], _.prototype, "open", void 0);
_ = te([b("w3m-alertbar")], _);
const xe = y `
  button {
    display: block;
    display: flex;
...
D.styles = [j, le, ce, xe];
oe([u()], D.prototype, "imageSrc", void 0);
D = oe([b("wui-select")], D);
const ke = y `
  :host {
    height: 64px;
...
function H() {
    var s, r, k, m, E, $, O;
    const n = (r = (s = l.state.data) == null ? void 0 : s.connector) == null ? void 0 : r.name,
        e = (m = (k = l.state.data) == null ? void 0 : k.wallet) == null ? void 0 : m.name,
        t = ($ = (E = l.state.data) == null ? void 0 : E.network) == null ? void 0 : $.name,
        i = e ? ? n,
        a = M.getConnectors();
    return {
...
let w = class extends C {
    ...
    leftHeaderTemplate() {
        ...
        const {
            view: e
        } = l.state, t = e === "Connect", i = T.state.enableEmbedded, a = e === "ApproveTransaction", o = e === "ConnectingSiwe", s = e === "Account", r = T.state.enableNetworkSwitch, k = a || o || t && i;
    ...
    onNetworks() {
        this.isAllowedNetworkSwitch() && (q.sendEvent({
            type: "track",
    ...
    async onHistoryChange() {
        ...
        const {
            history: e
        } = l.state, t = (i = this.shadowRoot) == null ? void 0 : i.querySelector("#dynamic");
...
f.styles = [j, We];
W([u()], f.prototype, "backgroundColor", void 0);
W([u()], f.prototype, "iconColor", void 0);
W([u()], f.prototype, "icon", void 0);
W([u()], f.prototype, "message", void 0);
W([u()], f.prototype, "loading", void 0);
W([u()], f.prototype, "iconType", void 0);
f = W([b("wui-snackbar")], f);
const Ee = y `
  :host {
    display: block;
    position: absolute;
...
U.styles = Ee;
ie([d()], U.prototype, "open", void 0);
U = ie([b("w3m-snackbar")], U);
const Ae = y `
  :host {
...
class v extends C {
    ...
    async onConnected(e) {
        ...
        const {
            ...
            chainId: i,
            address: a
        } = he.parseCaipAddress(e.caipAddress), o = `${t}:${i}`, s = !we.getPlainAddress(this.caipAddress), r = await R.getSessions({
            address: a,
            caipNetworkId: o
        }), k = R.getSIWX() ? r.some($ => $.data.accountAddress === a) : !0, m = e.isSwitchingNamespace && k && !this.enableEmbedded, E = this.enableEmbedded && s;
        m ? l.goBack() : E && p.close()
    }
    onNewNetwork(e) {
        var Y, X, G;
        const t = this.caipNetwork,
            i = (Y = t == null ? void 0 : t.caipNetworkId) == null ? void 0 : Y.toString(),
            a = t == null ? void 0 : t.chainNamespace,
            o = (X = e == null ? void 0 : e.caipNetworkId) == null ? void 0 : X.toString(),
            s = e == null ? void 0 : e.chainNamespace,
            r = i !== o,
            m = r && !(a !== s),
            E = (t == null ? void 0 : t.name) === me.UNSUPPORTED_NETWORK_NAME,
            $ = l.state.view === "ConnectingExternal",
            O = l.state.view === "ProfileWallets",
            ae = !((G = h.getAccountData(e == null ? void 0 : e.chainNamespace)) != null && G.caipAddress),
    ...
    prefetch() {
        this.hasPrefetched || (P.prefetch(), P.fetchWalletsByPage({
            page: 1
...
x([d()], v.prototype, "open", void 0);
x([d()], v.prototype, "caipAddress", void 0);
x([d()], v.prototype, "caipNetwork", void 0);
x([d()], v.prototype, "shake", void 0);
x([d()], v.prototype, "filterByNamespace", void 0);
let J = class extends v {};
J = x([b("w3m-modal")], J);
let Z = class extends v {};
Z = x([b("appkit-modal")], Z);
export {
    Z as AppKitModal, J as W3mModal, v as W3mModalBase
};