...
var i = function(d, e, t, l) {
    ...
    if (typeof Reflect == "object" && typeof Reflect.decorate == "function") r = Reflect.decorate(d, e, t, l);
        ...
        for (var s = d.length - 1; s >= 0; s--)(n = d[s]) && (r = (a < 3 ? n(r) : a > 3 ? n(e, t, r) : n(e, t)) || r);
...
let o = class extends p {
    ...
    render() {
        const e = this.iconSize || this.size,
            ...
            b = this.backgroundColor === "accent-100" && s || this.backgroundColor === "success-100" && s || this.backgroundColor === "error-100" && s || this.backgroundColor === "inverse-100" && s;
