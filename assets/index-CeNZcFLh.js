...
async function U() {
    ...
    if (t && !d.state.farcasterUrl) try {
        const {
            url: o
        } = await t.provider.getFarcasterUri();
...
async function j(t) {
    ...
    try {
        ...
        if (o && t) {
            if (c.isTelegram() || (e = T()), e) d.setSocialWindow(e, w.state.activeChain);
            else if (!c.isTelegram()) throw new Error("Could not create social popup");
            const {
                uri: n
            } = await o.provider.getSocialRedirectUri({
                provider: t
            });
...
var S = function(t, o, e, i) {
    ...
    if (typeof Reflect == "object" && typeof Reflect.decorate == "function") r = Reflect.decorate(t, o, e, i);
        ...
        for (var s = t.length - 1; s >= 0; s--)(a = t[s]) && (r = (n < 3 ? a(r) : n > 3 ? a(o, e, r) : a(o, e)) || r);
