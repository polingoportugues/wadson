...
var t = function(e, o, s, n) {
    var c = arguments.length,
        i = c < 3 ? o : n === null ? n = Object.getOwnPropertyDescriptor(o, s) : n,
        l;
    if (typeof Reflect == "object" && typeof Reflect.decorate == "function") i = Reflect.decorate(e, o, s, n);
    else
        for (var u = e.length - 1; u >= 0; u--)(l = e[u]) && (i = (c < 3 ? l(i) : c > 3 ? l(o, s, i) : l(o, s)) || i);
...
let a = class extends p {
    ...
    loadingTemplate() {
        if (this.loading) {
            const o = m[this.size],
                s = this.disabled ? v.disabled : v[this.variant];
...
t([r()], a.prototype, "variant", void 0);
t([r({
    type: Boolean
...
t([r()], a.prototype, "borderRadius", void 0);
t([r()], a.prototype, "textVariant", void 0);
a = t([b("wui-button")], a);